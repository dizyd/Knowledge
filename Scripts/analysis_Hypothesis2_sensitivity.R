...
res_kcal_OME <-  brm(OME_corr     ~ item_type + (item_type|ID) + (1|ID_item),
                     ...
                     cores        = bayes$cores,
                     file         = "Results/Models/fit_H2a_Kcal_M1_sensitivity.rds",
                     backend      = "rstan",
                     sample_prior = "yes",
...
res_kcal_OME0 <-  brm(OME_corr     ~ 1 + (item_type|ID) + (1|ID_item), 
                      ...
                      seed         = bayes$bayes_seed,
                      cores        = bayes$cores,
                      file         = "Results/Models/fit_H2a_Kcal_M0_sensitivity.rds",
                      backend      = "rstan",
                      sample_prior = "yes",
                      save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_kcal_OME, res_kcal_OME0) # 0.50286
...
res_kcal_rank <-  brm(rank_z       ~ item_type + (item_type|ID),
                      ...
                      seed         = bayes$bayes_seed,
                      cores        = bayes$cores,
                      file         = "Results/Models/fit_H2b_kcal_M1_sensitivity.rds",
                      backend      = "rstan",
                      sample_prior = "yes",
                      save_pars    = save_pars(all=TRUE))
...
res_kcal_rank0 <-   brm(rank_z       ~ 1 + (item_type|ID),
                        ...
                        seed         = bayes$bayes_seed,
                        cores        = bayes$cores,
                        file         = "Results/Models/fit_H2b_kcal_M0_sensitivity.rds",
                        backend      = "rstan",
                        sample_prior = "yes",
                        save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_kcal_rank, res_kcal_rank0) # 0.68791
