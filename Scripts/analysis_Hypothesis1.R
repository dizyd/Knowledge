...
res_kcal_OME <-  brm(OME_corr     ~ match_domain + (1|ID) + (match_domain|ID_item),
                     ...
                     cores        = bayes$cores,
                     file         = "Results/Models/fit_H1a_Kcal_M1.rds",
                     backend      = "rstan",
                     sample_prior = "yes",
...
res_kcal_OME0 <-  brm(OME_corr ~ 1 + (1|ID) + (match_domain|ID_item), 
                      ...
                      seed         = bayes$bayes_seed,
                      cores        = bayes$cores,
                      file         = "Results/Models/fit_H1a_Kcal_M0.rds",
                      backend      = "rstan",
                      sample_prior = "yes",
                      save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_kcal_OME, res_kcal_OME0) # 2.01401
...
res_CO2_OME <-  brm(OME_corr     ~ match_domain + (1|ID) + (match_domain|ID_item),
                    ...
                    seed         = bayes$bayes_seed,
                    cores        = bayes$cores,
                    file         = "Results/Models/fit_H1a_CO2_M1.rds",
                    backend      = "rstan",
                    sample_prior = "yes",
                    save_pars    = save_pars(all=TRUE))
...
res_CO2_OME0 <-  brm(OME_corr ~ 1 + (1|ID) + (match_domain|ID_item), 
                     ...
                     seed         = bayes$bayes_seed,
                     cores        = bayes$cores,
                     file         = "Results/Models/fit_H1a_CO2_M0.rds",
                     backend      = "rstan",
                     sample_prior = "yes",
                     save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_CO2_OME, res_CO2_OME0) # 2705.02275
...
res_kcal_rank <-  brm(rank_z       ~ match_domain + (1|ID), 
                      ...
                      seed         = bayes$bayes_seed,
                      cores        = bayes$cores,
                      file         = "Results/Models/fit_H1b_kcal_M1.rds",
                      backend      = "rstan",
                      sample_prior = "yes",
                      save_pars    = save_pars(all=TRUE))
...
res_kcal_rank0 <-   brm(rank_z         ~ 1 + (1|ID), 
                        ...
                        seed         = bayes$bayes_seed,
                        cores        = bayes$cores,
                        file         = "Results/Models/fit_H1b_kcal_M0.rds",
                        backend      = "rstan",
                        sample_prior = "yes",
                        save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_kcal_rank, res_kcal_rank0) # 0.39101
...
res_CO2_rank  <-  brm(rank_z       ~ match_domain + (1|ID), 
                      ...
                      seed         = bayes$bayes_seed,
                      cores        = bayes$cores,
                      file         = "Results/Models/fit_H1b_CO2_M1.rds",
                      backend      = "rstan",
                      sample_prior = "yes",
                      save_pars    = save_pars(all=TRUE))
...
res_CO2_rank0  <-   brm(rank_z       ~ 1 + (1|ID), 
                        ...
                        seed         = bayes$bayes_seed,
                        cores        = bayes$cores,
                        file         = "Results/Models/fit_H1b_CO2_M0.rds",
                        backend      = "rstan",
                        sample_prior = "yes",
                        save_pars    = save_pars(all=TRUE))
...
bayes_factor(res_CO2_rank, res_CO2_rank0) # 0.13637
